...
import { generateVideo, getVideos, generateScript, getAvatars, getVoices, getPublicVideo, getStyles, generateKlingUgcAd } from '../controllers/video.controller';
...
router.post('/generate-kling-ugc', protect as any, generateKlingUgcAd as any);
